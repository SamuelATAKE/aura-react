  ...
  return (
    <>
      ...
      <header className="header_i">
        <img src="../assets/img/logo_black.png" alt="" loading="lazy" />
      </header>
      <main>
        ...
        <section class="services_i">
          ...
          <div class="the-services_i">
            <div class="service_i service-crea_i">
              <h3>CREA 360°</h3>
              <img src="../assets/img/crea360.png" alt="Service 1" loading="lazy" />
            </div>
            <div class="service_i service-event_i">
              <h3>EVENT</h3>
              <img src="../assets/img/event.png" alt="Service 2" loading="lazy" />
            </div>
            <div class="service_i service-tech_i">
              <h3>TECH</h3>
              <img src="../assets/img/tech.png" alt="Service 3" loading="lazy" />
            </div>
          </div>
        </section>
